        ...
        <div class="row text-center">
            <fieldset id="fld_dskhoacham" runat="server" visible="false">
                <table align="center">
                    ...
                    <tr>
                        <tb>
                        <asp:GridView ID="grv_dsCTCT_Cham" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowCommand="grv_dsCTCT_Cham_RowCommand">
                            <Columns>
                                        ...
                                        <fieldset id="fieldset_diem" runat="server" visible="true">
                                            <table border="1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%" class="text-center">
                                                        <asp:TextBox ID="TextBox1" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="false" AutoPostBack="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="text-align: left">
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox2" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="text-align: left">
                                                    <td>1.2.</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox3" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox4" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="text-align: left">
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox5" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox6" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="text-align: left">
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox7" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox8" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="text-align: left">
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox10" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox9" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="text-align: left">
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox11" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox12" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="text-align: left">
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox13" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox14" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>1.3</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox15" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="false"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox16" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox17" runat="server" Text="0" Width="50px" CssClass="text-center" AutoPostBack="True" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox18" runat="server" Text="0" Width="50px" CssClass="text-center" AutoPostBack="True" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox19" runat="server" Text="0" Width="50px" CssClass="text-center" AutoPostBack="True" Enabled="False"></asp:TextBox>
                                                    </td>
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox20" runat="server" Text="0" Width="50px" CssClass="text-center" AutoPostBack="True" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2.</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox21" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2.1</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox22" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2.2</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox23" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2.3</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox24" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2.4</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox25" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2.5</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox26" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3.</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox27" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3.1</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox28" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3.2</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox29" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3.3</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox30" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3.4</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox31" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3.5</td>
                                                    ...
                                                    <td class="text-center">
                                                     ...
                                                     <td class="text-center">
                                                        <asp:TextBox ID="TextBox32" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>4.</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox33" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="False"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>4.1</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox34" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>4.2</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox35" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>4.3</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox36" runat="server" Text="0" Width="50px" CssClass="text-center"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>4.4</td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox37" runat="server" Text="0" Width="50px" CssClass="text-center" MaxLength="5"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    ...
                                                    <td class="text-center">
                                                        <asp:TextBox ID="TextBox38" runat="server" Text="0" Width="50px" CssClass="text-center" Enabled="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="6">
